...
} from "@/components/sections/ExperiencesSection";
import {
  EventsSection,
  type EventShowcase,
...
import {
  RequestEventSection,
  type RequestEventFormData,
} from "@/components/sections/RequestEventSection";
  ...
  return (
    <div className="min-h-screen text-[#1A032D]">
      ...
      <footer className="border-t border-white/30 font-sans bg-[#681155] py-10 text-center text-sm text-white">
        <p>
          © {new Date().getFullYear()} FotoFest — გაიღიმე · გადაიღე · გააზიარე
        </p>
      </footer>
    </div>
  );
